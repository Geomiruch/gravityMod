...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> FALLING_COBBLE = BLOCKS.register("falling_cobble", () -> new FallingDamagingBlock(Block.Properties.of(Material.STONE).strength(3.0F, 3.0F).harvestTool(ToolType.PICKAXE)));
    public static final RegistryObject<Block> FALLING_GRANITE_COBBLE = BLOCKS.register("falling_granite_cobble", () -> new FallingDamagingBlock(Block.Properties.of(Material.STONE).strength(3.0F, 3.0F).harvestTool(ToolType.PICKAXE)));
    public static final RegistryObject<Block> FALLING_DIORITE_COBBLE = BLOCKS.register("falling_diorite_cobble", () -> new FallingDamagingBlock(Block.Properties.of(Material.STONE).strength(3.0F, 3.0F).harvestTool(ToolType.PICKAXE)));
    public static final RegistryObject<Block> FALLING_ANDESITE_COBBLE = BLOCKS.register("falling_andesite_cobble", () -> new FallingDamagingBlock(Block.Properties.of(Material.STONE).strength(3.0F, 3.0F).harvestTool(ToolType.PICKAXE)));
