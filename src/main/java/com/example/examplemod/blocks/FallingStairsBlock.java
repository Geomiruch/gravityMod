...
public class FallingStairsBlock extends Block implements IWaterLoggable
{
    ...
    protected static final VoxelShape TOP_AABB = FallingSlabBlock.TOP_AABB;
    protected static final VoxelShape BOTTOM_AABB = FallingSlabBlock.BOTTOM_AABB;
    ...
    public FallingStairsBlock(BlockState p_i48321_1_, AbstractBlock.Properties p_i48321_2_) {
        super(p_i48321_2_);
